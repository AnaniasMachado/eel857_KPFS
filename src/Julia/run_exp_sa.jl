...
for scenario in scenarios
    for type in types
        for size in sizes
            ...
            if (scenario == 1)
                continue
            elseif (scenario == 2) && (type == "correlated_sc")
                continue
            elseif (scenario == 2) && (type == "fully_correlated_sc") && (size in [300, 500, 700, 800])
                continue
            elseif (scenario == 2) && (type == "fully_correlated_sc") && (size == 1000)
                for idx in 2:10
                    try
