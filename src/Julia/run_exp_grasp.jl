    ...
    for type in types
        for size in sizes
            ...
            if (scenario == 1) && (type == "correlated_sc") 
                continue
            elseif (scenario == 1) && (type == "fully_correlated_sc")
                continue
            elseif (scenario == 1) && (type == "not_correlated_sc") && (size in [300, 500, 700])
                continue
            elseif (scenario == 1) && (type == "not_correlated_sc") && (size == 800)
                for idx in 5:10
                    try
